                ...
                Expanded(
                  child: sessions.isEmpty
                    ...
                    : TabBarView(
                        ...
                        children: sessions.map((s) => TerminalWidget(sessionId: s.id)).toList(),
                      ),
                ),
              ],
            ),
  ...
  Widget _buildTopBar(BuildContext context, dynamic sessions) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: Colors.white.withAlpha(20), width: 0.5)),
      ),
      child: Row(
        children: [
          // Session Tabs
          ...
          // Add Session Button
          IconButton(
            icon: const Icon(Icons.add_rounded, color: AppThemes.accentBlue),
            onPressed: () => ref.read(terminalServiceProvider).createSession(
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.terminal_rounded, size: 64, color: Colors.white.withAlpha(20)),
          ...
          ElevatedButton.icon(
            onPressed: () => ref.read(terminalServiceProvider).createSession(isRoot: true),
