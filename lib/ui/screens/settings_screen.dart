...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Future<void> _loadAll() async {
    ...
    _localModelCtrl.text =
        await keystore.retrieve('LOCAL_AI_MODEL') ?? 'llama3';
          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: AppThemes.bgDark.withAlpha(200),
                border: Border(
                  bottom: BorderSide(
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: RadialGradient(
            ...
            radius: 1.5,
            colors: [
              Color(0xFF0F172A), // Subtle Frosted Obsidian mesh top right
                  ...
                  _buildCard([
                    ListTile(
                      ...
                      leading: Container(
                        ...
                        child: Icon(
                          allModels
                              .firstWhere((m) => m.id == _activeProvider)
                              .icon,
                    ...
                    Padding(
                      ...
                      child: _buildTextField(
                        ...
                        onSave: () async {
                          ...
                          await ks.store(
                            'OPENROUTER_MODEL',
                            _openrouterModelCtrl.text.trim(),
                          );
                          ref.invalidate(aiProviderServiceProvider);
                          if (mounted) {
                            messenger.showSnackBar(
                              const SnackBar(
                                content: Text('OpenRouter Model saved ✅'),
                              ),
                            );
                          }
                        },
  ...
  Widget _divider() {
    return Divider(height: 1, indent: 52, color: AppThemes.dividerColor);
  }
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  onSubmitted: (_) =>
                      _saveKey(keystoreKey, ctrl.text, model.id),
                ),
              ],
            ),
          ),
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: AppThemes.accentCyan.withAlpha(isSaving ? 60 : 20),
                borderRadius: BorderRadius.circular(8),
              ),
              child: isSaving
                  ? const SizedBox(
      ...
      child: Container(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            items: finalOptions.map<DropdownMenuItem<String>>((
              String modelStr,
            ) {
